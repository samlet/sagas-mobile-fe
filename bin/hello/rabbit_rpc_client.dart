...
class RPCClient {
  ...
  RPCClient(this.queueTag) : client = new Client() {
  ...
  void handler(AmqpMessage event) {
    if (!_channels.containsKey(event.properties.corellationId)) return;
...
void main(List<String> arguments) {
  ...
  */
  // RPCClient client = new RPCClient("rpc_queue");
  RPCClient client = new RPCClient("rpc_queue_1");
